<template>
  <div class="warpper">
    <div class="toolbar">
      <el-button type="primary" plain @click="add">添加学生</el-button>
      <el-button type="primary" plain @click="uploadData">导入学生</el-button>
    </div>
    <div class="table">
      <el-table
        :data="tableData"
      ...
      >
        ...
        <el-table-column label="状态" width="160">
          <template v-slot="scope">
            <span v-if="scope.row.email === 'test'" />
            <el-switch
              v-else
...
export default {
  ...
  methods: {
    ...
    async changeStatus(content) {
      this.$confirm("此操作将修改学生状态, 是否继续?", "提示", {
