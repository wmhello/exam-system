...
{
    use Tool;
    protected  $model = 'App\Models\Article';  // 当前模型
    protected  $fillable = ['title','author' ,'content'];  // 当前模型可以修改和新增的字段
    protected  $resource = 'App\Http\Resources\Article'; // 显示个体资源
    protected  $resourceCollection = 'App\Http\Resources\ArticleCollection'; // 显示资源集合
    ...
    protected  function  getListData($pageSize){
        // 当前列表数据  对应于原来的index
        $data = $this->model::orderBy('id', 'desc')->paginate($pageSize);
