...
class QuestionTypeController extends Controller
{
    ...
    use Tool;
    protected  $model = 'App\Models\QuestionType';  // 当前模型
    protected  $fillable = ['name', 'desc', 'num'];  // 当前模型可以修改和新增的字段
    protected  $resource = 'App\Http\Resources\QuestionType'; // 显示个体资源
    protected  $resourceCollection = 'App\Http\Resources\QuestionTypeCollection'; // 显示资源集合
...
//        2. 根据校验的结果，计算出可以导入的条数，以及错误的内容
    ...
    protected function  message(){
        return [
            "name.required" => "题目类型名称不能为空",
            "name.unique" => "题目类型名称不能重复"
        ];
    }
}
