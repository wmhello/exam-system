...
{
    use Tool;
    protected  $model = 'App\Models\TestPaper';  // 当前模型
    protected  $fillable = ["show_id", "question", "type_id", "level_id", "a", "b", "c", "d", "correct", "choose", "score"];  // 当前模型可以修改和新增的字段
    protected  $resource = 'App\Http\Resources\TestPaper'; // 显示个体资源
    protected  $resourceCollection = 'App\Http\Resources\TestPaperCollection'; // 显示资源集合
